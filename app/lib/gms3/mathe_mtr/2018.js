...
→ Winkel am Boden: 45°
→ Bei einem 45°-Winkel sind die beiden Katheten gleich lang.
→ Höhe des Ständers = Bodenlänge s₁ = 15 cm.
...
d = √(h² + b²)`,
...

        {
          ...
          content: `Der Ständer ist bei h/2 befestigt und hat eine Höhe von 15 cm.
h/2 = 15 cm
h = 30 cm
✅ h = 30.00 cm`,
...
✅ Diagonale d ≈ 54.08 cm`,
      ...
      tip: `🍳 Kochrezept:
1️⃣  Ständer: 45° → Höhe des Stützdreiecks = Bodenlänge s₁.
2️⃣  Tablet-Höhe h: Ständer ist bei h/2 befestigt → h = 2 × Ständerhöhe.
3️⃣  Breite: b = (3/2) × h (aus Verhältnis 2:3).
4️⃣  Diagonale: d = √(h² + b²).`,
...
→ Strecke = Abstand_hinter + Länge_blau + Länge_rot + Abstand_vorn`,
...
Zeit = 450 km ÷ 250 km/h = 1.8 h
1.8 h * 60 min/h = 108 Minuten
✅ Die Züge begegnen sich nach 108 Minuten.`,
...

        {
          ...
          content: `Gesamtstrecke = 15.6 km + 0.35 km = 15.95 km
Zeit = 15.95 km ÷ 110 km/h = 0.145 h
0.145 h * 3600 s/h = 522 Sekunden
522 s = 8 Minuten und 42 Sekunden
✅ Die Durchfahrt dauert 8 min 42 s.`,
...

        {
          ...
          content: `Relativgeschwindigkeit = 90 − 72 = 18 km/h. Umrechnen: 18 / 3.6 = 5 m/s.
Aufzuholende Strecke = 10m + 4m + 5m + 10m = 29 m
Zeit = Strecke / Relativgeschwindigkeit = 29 m ÷ 5 m/s = 5.8 Sekunden
