...
In 24 Stunden (4 Kästchen) steigt der Wasserstand von 40 auf 50cm, also 10cm.
Rate = 10cm / 24h.
Benötigte Zeit = Fehlende Höhe / Rate = 85cm / (10cm/24h) = 85 * 2.4 h = 204 Stunden.
204 Stunden = 8 Tage und 12 Stunden.
Start: 5.7. um 00:00 + 8 Tage 12h = 13.7. um 12:00 Uhr.
(Die offizielle Lösung hat eine andere Ablesung/Rechnung, die zu 10.7. führt)
✅ Unsere Rechnung ergibt den 13. Juli, 12:00 Uhr.`,
...
→ e = a · √2 / 2 (halbe Bodendiagonale der Grundfläche)
→ h = √(s² − e²)
...
          content: `Schritt 1: Abstand vom Zentrum zur Ecke (halbe Bodendiagonale)
e² = (a/2)² + (a/2)² = 2 * (6/2)² = 18
e = √18 ≈ 4.2426 m
...
      tip: `🍳 Kochrezept:
1️⃣  Halbe Diagonale e: e² = (a/2)² + (a/2)²
...
          content: `Strategie: Einzelteile addieren
1. Dunkles Parallelogramm (Mitte):
   Basis = 39 - 3 = 36 m
   Höhe = 19 m
   A_pgram = 36 * 19 = 684 m²

2. Dunkles Rechteck (unten):
   Breite = 50 m
   Höhe = 19 m
   A_rechteck = 50 * 19 = 950 m²

3. Dunkles Dreieck (links):
   Breite = 11m
   Höhe = 19 + 19 = 38m
   A_dreieck = (11 * 38) / 2 = 209 m²

4. Total Dunkel:
   A_dunkel = 684 + 950 + 209 = 1843 m²
(Hinweis: Die offizielle Lösung könnte einen anderen Weg gehen. Diese Zerlegung ist eine Möglichkeit.)`,
...
Hinweis zur Figur:
• α liegt am linken Rand des Kreises (Umfangswinkel)
...
          content: `🔵 Umfangswinkel (Inskriptionswinkel)
→ Ein Winkel mit Scheitel auf dem Kreis.
...
          content: `Aus der Figur der offiziellen Lösung:
1. Das Dreieck mit dem Winkel β hat einen 90° Winkel (Thales-Satz, da eine Seite der Durchmesser ist).
2. Der dritte Winkel in diesem Dreieck ist also 180° - 90° - 17° = 73°.
3. Dieser 73°-Winkel und der Winkel α sind beides Umfangswinkel über dem gleichen Bogen.
4. Daher gilt: α = 73°.
✅ Der Winkel α beträgt 73°.`,
...
1️⃣  Thales: Winkel im Halbkreis = immer 90°
2️⃣  Winkelsumme im Dreieck = 180°
3️⃣  Umfangswinkel über gleichem Bogen → immer gleich gross
⚠️  Immer zuerst die Figur genau anschauen und bekannte Sätze anwenden!`,
...
→ "Mindestens" für Kat. A bedeutet: wir nehmen an, dass zuerst die anderen, günstigeren Kategorien B und C voll besetzt werden. Die restlichen Besucher gehen in Kategorie A.`,
...
3️⃣  "Mindestens": Besetzte Plätze total - Plätze B - Plätze C = Rest für A
4️⃣  Freikarten abziehen: Zahlende = Plätze − (Plätze × Freikarten%)
5️⃣  Einnahmen: Zahlende × Preis`,
