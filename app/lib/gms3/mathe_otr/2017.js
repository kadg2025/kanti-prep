...
a) Vereinfache den Term: (100x² · √(y⁴/100) – (3xy)²) / (12 · √(x²y²) – 11xy)
b) Berechne den Wert des vereinfachten Terms für x = 3 und y = 4.`,
    ...
    solution: {
      ...
      intro: 'Zähler und Nenner sehen kompliziert aus, lassen sich aber getrennt vereinfachen — danach bleibt nur noch ein einfacher Bruch übrig.',
      ...
      steps: [

        {
          ...
          content: `Wurzel eines Quadrats: √(a²) = a (für a ≥ 0). Steht unter der Wurzel ein Bruch mit einer geraden Potenz, wendest du die Wurzel auf Zähler und Nenner einzeln an: √(y⁴/100) = y²/√100 = y²/10.

Quadrat eines Produkts: (a·b)² = a²·b² — jeder Faktor wird einzeln quadriert.

Kürzen: Haben Zähler und Nenner einen gemeinsamen Faktor, darfst du ihn wegkürzen.`,

        },

        {

          title: 'a) Zähler vereinfachen',
...
Zähler gesamt: 10x²y² – 9x²y² = x²y²`,

        },

        {

          title: 'a) Nenner vereinfachen',

          content: `√(x²y²) = xy

Nenner gesamt: 12xy – 11xy = xy`,
...

        {
          ...
          content: `Gesamter Bruch: x²y² / xy
Kürzen mit xy: x²y²/xy = xy
✅ Der vereinfachte Term ist xy.`,
...

        {
          ...
          content: `Setze die Werte in den vereinfachten Term xy ein:
xy = 3 · 4 = 12
✅ Der Wert ist 12.`,
      ...
      tip: `🍳 Dein Gameplan:
1. Wurzeln zuerst vereinfachen (√ auf Zähler/Nenner einzeln anwenden).
2. Quadrate einzeln ausrechnen: (a·b)² = a²·b².
3. Zähler und Nenner getrennt zusammenfassen.
4. Erst ganz am Schluss kürzen.`,

    },

    // ── ÜBUNGEN: aufbauend zu Wurzeln, Potenzen und Kürzen. Antwort eintippen (Reihenfolge egal).
    //    Tipps sind high-level: nur Konzept, keine Zahlen, keine Lösung.
    practice: [
      { level: 'einfach', q: 'Vereinfache: √(x²)', answer: 'x', tip: 'Die Wurzel hebt das Quadrieren wieder auf (für x ≥ 0).' },
      { level: 'einfach', q: 'Vereinfache: √(100)', answer: '10', tip: 'Welche Zahl mal sich selbst ergibt 100?' },
      { level: 'einfach', q: 'Fasse zusammen: 12xy – 11xy', answer: 'xy', tip: 'Gleiche Variablenteile zusammenzählen, wie bei normalen Zahlen.' },

      { level: 'mittel', q: 'Vereinfache: √(x²y²)', answer: 'xy', tip: 'Die Wurzel wirkt auf jeden Faktor im Produkt einzeln.' },
      { level: 'mittel', q: 'Kürze: (12x²y²) / (4xy)', answer: '3xy', tip: 'Kürze die Zahlen und die gleichnamigen Variablen jeweils separat.' },
      { level: 'mittel', q: 'Fasse zusammen: 10a – 9a', answer: 'a', tip: 'Nur die Zahl vor dem gleichen Variablenteil wird subtrahiert — der Rest bleibt gleich.' },

      { level: 'schwer', q: 'Vereinfache und kürze: (x²y²) / (xy)', answer: 'xy', tip: 'Kürze den gemeinsamen Faktor aus Zähler und Nenner.' },
      { level: 'schwer', q: 'Kürze so weit wie möglich: (100x²y²) / (10xy)', answer: '10xy', tip: 'Kürze die Zahlen und die gleichnamigen Variablen jeweils separat.' },

      { level: 'kanti', q: 'Vereinfache den ganzen Bruch: (100x² · √(y⁴/100) – (3xy)²) / (12 · √(x²y²) – 11xy)', answer: 'xy', tip: 'Vereinfache Zähler und Nenner getrennt und kürze erst ganz am Schluss.' },
      { level: 'kanti', q: 'Setze in den vereinfachten Term xy die Werte x=3, y=4 ein.', answer: '12', tip: 'Einfach einsetzen und ausmultiplizieren — keine weitere Vereinfachung nötig.' },
    ],
...
d) A = (π/4)*(D² - d²) (nach d)`,
    ...
    options: [
      ...
      { label: 'a) b=2A/r | b) v=n·d·π | c) m=2a/(z+x) | d) d=√(D²–4A/π)', correct: true },

      { label: 'a) b=A/2r | b) v=n/(dπ) | c) m=2a/(z+x) | d) d=√(D²–4A/π)', correct: false },
...
2a = mz + mx   | m auf der rechten Seite ausklammern
...
5. Zum Schluss die letzte Hülle (Potenz, Wurzel) entfernen.`,
    ...
    // ── ÜBUNGEN: aufbauend zum Formeln-Umstellen (Nenner wegmultiplizieren, ausklammern, Wurzel ziehen).
    //    Tipps sind high-level: nur Konzept, keine Zahlen, keine Lösung.
    practice: [
      { level: 'einfach', q: 'Löse nach x auf: y = x/4', answer: 'x=4y', tip: 'Multipliziere beide Seiten mit dem Nenner.' },
      { level: 'einfach', q: 'Löse nach x auf: y = x*k', answer: 'x=y/k', tip: 'Dividiere beide Seiten durch den Faktor vor x.' },
      { level: 'einfach', q: 'Löse nach y auf: x = y – 7', answer: 'y=x+7', tip: 'Mach die Rechenoperation rückgängig — aus minus wird plus.' },

      { level: 'mittel', q: 'Löse nach b auf: A = (b*h)/2', answer: 'b=2A/h', tip: 'Erst mit 2 multiplizieren, dann durch den verbleibenden Faktor teilen.' },
      { level: 'mittel', q: 'Löse nach w auf: p = w/k', answer: 'w=p*k', tip: 'Multipliziere beide Seiten mit dem Nenner.' },
      { level: 'mittel', q: 'Löse nach x auf: y = 4x – 8', answer: 'x=(y+8)/4', tip: 'Erst die Zahl auf die andere Seite bringen, dann durch den Faktor vor x teilen.' },

      { level: 'schwer', q: 'Löse nach k auf: a = (kp+kq)/2', answer: 'k=2a/(p+q)', tip: 'Mit 2 multiplizieren, dann k auf der rechten Seite ausklammern.' },
      { level: 'schwer', q: 'Löse nach d auf: A = h*(D–d)', answer: 'd=D-A/h', tip: 'Erst durch den Faktor vor der Klammer teilen, dann d isolieren.' },

      { level: 'kanti', q: 'Löse nach m auf: a = (mz+mx)/2', answer: 'm=2a/(z+x)', tip: 'Nenner wegmultiplizieren, dann m auf der rechten Seite ausklammern.' },
      { level: 'kanti', q: 'Löse nach b auf: A = (b*r)/2', answer: 'b=2A/r', tip: 'Gleiches Vorgehen wie bei der vorherigen Aufgabe.' },
    ],
